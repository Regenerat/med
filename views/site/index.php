...
<div class="site-index">
    ...
    <div class="jumbotron text-left bg-transparent mt-5 mb-5">
        <h1 class="display-4">Медицинская клиника Мед-Плюс</h1>
    </div>

    <div class="br-block-green bg-gradient col-lg-12">
        <div class="container">
            <div class="row my-4 mx-2">
                ...
                <div class="col-sm-9">
                    ...
                    <p class=" d-flex justify-content-end">генеральный директор группы компаний «Мед-Плюс»</p>
                </div>               
            </div> 
        </div>            
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-7 br-block-grey mt-5 px-4 py-4">
                    ...
                    <p class=" d-flex justify-content-left">В детских отделениях ведут приём доктора, специализирующиеся на лечении детей с первых дней жизни до совершеннолетия.</p>
                </div>
                <div class="col-sm-5 mt-5 g-0 g-sm-5">
                    <div class="br-block-green px-4 py-4">
                        <p class="lead d-flex justify-content-left fw-semibold">> 3500</p>
                        <p class=" d-flex justify-content-left">медицинских специалистов</p>
                    </div>
                    <div class="br-block-green mt-5 px-4 py-4">
                        <p class="lead d-flex justify-content-left fw-semibold">> 3000</p>
                        <p class=" d-flex justify-content-left">врачей, в том числе редких специальностей</p>
                    </div>
                    <div class="br-block-green mt-5 px-4 py-4">
                        <p class="lead d-flex justify-content-left fw-semibold">38% врачей имеют ученые степени</p>
                        <p class=" d-flex justify-content-left">доктора и кандидаты наук, научные сотрудники, доценты и профессора, врачи высшей, I и II категории, заслуженные врачи РФ</p>
                    </div> 
                </div>               
            </div> 
        </div>            
